            ...
            <div className="mx-auto max-w-2xl lg:max-w-5xl">
              <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                ...
                <div className="lg:order-first lg:row-span-2">
                  ...
                  <div className="mt-6 space-y-7 font-medium text-base text-zinc-600 dark:text-zinc-400">
                ...
                <div className="lg:pl-40">
                  <ul>
                    ...
                    <li className="mt-4 flex border-zinc-100 border-t dark:border-zinc-700/40">
                      <a
                        className="group flex font-medium text-sm text-zinc-800 transition hover:text-teal-500 dark:text-zinc-200 dark:hover:text-teal-500"
