    ...
    <div className={pageStyles.aboutGrid}>
      <div>
        ...
        <div className={pageStyles.prose}>
          ...
          <p>
            At EverQuote, I work across Platform Engineering and AI Engineering.
            My platform work includes observability, shared AWS services,
            Kubernetes, Lambda, Terraform, and automated compliance. On the AI
            side, I&apos;ve shipped production MCP servers and agentic
            applications used by engineers, product managers, and leadership. I
            also help lead AI adoption across the engineering organization.
          </p>
          <p>
            ...
            reliability work repeatable. If your team is working through a
            difficult engineering problem,{" "}
            <a href="mailto:hello@ivansantos.me">I&apos;d be glad to talk</a>.
          </p>
          <p>
