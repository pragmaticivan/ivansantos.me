      ...
      <div>
        <div>
          <header className={pageStyles.intro}>
            <h1 className={pageStyles.title}>Uses</h1>
            <p className={pageStyles.lead}>
              The hardware, software, and small comforts that help me do
              thoughtful work.
            </p>
          </header>
          <div>
            <Image
              ...
              className={clsx(pageStyles.image, styles.heroImage)}
              loading="eager"
              src={ivanDeskSetup}
            />
          </div>
          <div className={clsx(pageStyles.prose, styles.content)}>
            <div>
              <p>
            ...
            <h2 className={pageStyles.sectionTitle}>Desk setup</h2>
            ...
            <ul>
              ...
              <li>
                ...
                great desk. I&apos;ve had it for 5 years now and it&apos;s still
                going strong.
              </li>
              <li>
                Everything, including monitors, Ethernet, hard drives, webcam,
                and power, is plugged in via a single USB cable and piped into
                my{" "}
            ...
            <h2 className={pageStyles.sectionTitle}>Sound & video</h2>
            ...
            <h2 className={pageStyles.sectionTitle}>Editor & terminal</h2>
            <ul>
              <li>
                <a href="https://code.visualstudio.com">Visual Studio</a> Code
                is my current editor. I&apos;ve been using it for a few years
                now and I don&apos;t have any reason to switch. I do use vim for
                quick edits.
              </li>
              <li>
                I mainly use <a href="https://iterm2.com/">iTerm2</a>, but have
                been contemplating a switch to{" "}
                <a href="https://www.warp.dev">Warp Terminal</a>.
              </li>
              <li>
                You can see most of my config files over at my{" "}
                <a href="https://github.com/pragmaticivan/dotfiles">DotFiles</a>{" "}
                repo.
              </li>
            </ul>

            <h2 className={pageStyles.sectionTitle}>Apps</h2>
            <ul>
              <li>
              ...
              <li>
                It’s about time. I use <a href="https://cron.com/">Cron</a> for
                scheduling.
              </li>
              <li>
                <a href="https://1password.com/">1Password</a> is my password
                manager of choice. I&apos;ve been using it for years and
                that&apos;s usually the first app I install in any new supported
                device.
              </li>
              <li>
                I was born in Brazil and I&apos;ve been living in the US for the
                past 11 years, yet, english doesn&apos;t feel like my first
                language. I use{" "}
              ...
              <li>
                ...
                is my go to for all my design needs. I use Affinity Designer and
                Affinity Photo.
              </li>
            </ul>

            <h2 className={pageStyles.sectionTitle}>Changelog</h2>
